...
$.fn.editInPlace.defaults = {
	...
	save_button:		'<input type = image src = "images/tick.png" class="inplace_save" width = 20px height = 20px/>', // string: image button tag to use as “Save” button
	cancel_button:		'<input type = image src = "images/delete.png" class="inplace_save" width = 20px height = 20px/>', // string: image button tag to use as “Cancel” button
