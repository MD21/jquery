 ...
 $(document).ready(function(){
   ...
   $("#todos > ul > li > ul").delegate(" div#todo_box > img","click", function(){
     ...
     var add_img = $("<input />").attr("class","inplace_save add").attr("type","image").attr("src","images/save.png");
     var delete_img = $("<input />").attr("class","delete inplace_cancel").attr("type","image").attr("src","images/delete.png");
  ...
  $("#todos >ul> img").click(function(e){
   ...
   if(li_display == 'expand')
    $(this).siblings("li").children().children("li").css("display","block");
   else
    $(this).siblings("li").children().children("li").css("display","none");
  ...
  $("#employees").delegate(".ui-draggable ","mouseover mouseout", function(event){
    ...
    if (event.type == 'mouseover') 
    {
      ...
      var del = $("<img />").attr("src","images/delete.png").css("height","20px").css("width","20px");
      del.prependTo($(li));
